...
<head>
  ...
  <title>Admin Profile - Food Bank</title>
  ...
  <div class="row g-4">
    <div class="col-lg-8">
      <div class="card shadow-sm border-0">
        <div class="card-header bg-dark text-white"><i class="bi bi-shield-lock me-2"></i>Account</div>
        <div class="card-body">
          <form action="${pageContext.request.contextPath}/app/profile/update" method="post">
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label">Name</label>
                <input type="text" class="form-control" placeholder="Admin User" />
              </div>
              <div class="col-md-6">
                <label class="form-label">Email</label>
                <input type="email" class="form-control" placeholder="admin@foodbank.org" />
              </div>
              <div class="col-12">
              ...
              <div class="col-12 d-flex gap-2 mt-2">
                <button type="submit" class="btn btn-dark"><i class="bi bi-save me-1"></i>Save</button>
    ...
    <div class="col-lg-4">
      <div class="card shadow-sm border-0 h-100">
        ...
        <div class="card-body d-grid gap-2">
          ...
          <a class="btn btn-outline-success" href="${pageContext.request.contextPath}/app/reports/analytics">Reports & Analytics</a>
          <a class="btn btn-outline-secondary" href="${pageContext.request.contextPath}/app/inventory/manage">Inventory</a>
        </div>
      </div>
    </div>
  </div>
